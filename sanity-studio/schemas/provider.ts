...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'วาง Group ID (C…) ของกลุ่มรับคิวร้าน หรือ User ID (U…) ของเจ้าของร้าน · วิธีขอรหัส: เชิญ @aquamx เข้ากลุ่ม (หรือแอดเพื่อนแล้วทักแชท) แล้วพิมพ์คำว่า "id" — bot จะตอบรหัสให้ทันที ถามซ้ำได้ทุกเมื่อ (คู่มือส่งให้ร้าน: LINE-SHOP-CONNECT.md) · กติกา LINE ที่ทำให้พัง: กลุ่มต้องมีแต่คนจริง + aquamx เท่านั้น (มี OA อื่นอยู่ = aquamx เด้งออก, ใช้ OA ของร้านเป็นปลายทาง = ส่งไม่ถึง) · เว้นว่าง = คำขอแจ้งเราอย่างเดียว',
    }),
    defineField({
      name: 'leadRelay',
