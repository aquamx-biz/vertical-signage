...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'ใส่ได้ 2 แบบ — แบบกลุ่ม: เชิญ OA aquamx เข้ากลุ่มไลน์ร้าน พิมพ์อะไรก็ได้ 1 ครั้ง bot ตอบ Group ID (ขึ้นต้น C) · แบบคนเดียว: เจ้าของร้านเพิ่มเพื่อนที่ line.me/R/ti/p/@aquamx แล้วทักแชท 1 ข้อความ bot ตอบ User ID (ขึ้นต้น U) · คัดลอก ID มาวางที่นี่ · เว้นว่าง = คำขอแจ้งเราอย่างเดียว · ⚠️ ข้อจำกัด LINE: ส่งเข้า LINE OA ของร้านไม่ได้ (OA คุยกับ OA ไม่ได้) — ต้องเป็นกลุ่ม/บัญชีส่วนตัวของทีมร้านเท่านั้น · และ 1 กลุ่มมี OA ได้ตัวเดียว: ถ้ากลุ่มร้านมี OA ของเขาอยู่แล้ว aquamx จะเด้งออกทันที ต้องตั้งกลุ่มใหม่แยกรับคิว (คนจริง + aquamx เท่านั้น)',
    }),
    defineField({
      name: 'leadRelay',
