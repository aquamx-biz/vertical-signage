...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'วาง Group ID (C…) ของกลุ่มรับคิวร้าน หรือ User ID (U…) ของเจ้าของร้าน — bot จะบอก ID เองเมื่อร้านทำตามขั้นตอน (ดูวิธีส่งให้ร้านในคู่มือ "เชื่อม LINE ร้าน") · กติกา LINE ที่ทำให้พัง: กลุ่มต้องมีแต่คนจริง + aquamx เท่านั้น (มี OA อื่นอยู่ = aquamx เด้งออก, ใช้ OA ของร้านเป็นปลายทาง = ส่งไม่ถึง) · เว้นว่าง = คำขอแจ้งเราอย่างเดียว',
    }),
    defineField({
      name: 'leadRelay',
