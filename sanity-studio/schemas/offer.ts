...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'object',
      hidden: ctaGate('book'),
      description: 'Open–close always follows the store\'s Opening Hours · เวลาเปิด-ปิดมาจาก Opening Hours ของร้านเสมอ — ที่นี่ทับได้เฉพาะเรื่องคิว เว้นว่าง = ใช้ Booking Schedule ของร้านทั้งหมด',
      options: { collapsible: true, collapsed: false, columns: 2 },
      fields: [
