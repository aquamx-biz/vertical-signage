  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'daysAhead', title: 'เปิดให้เลือกกี่วัน', type: 'number', description: 'จำนวนวันในปฏิทินที่ลูกค้าเลือกได้ นับจากวันแรกที่จองได้ (เช่น 3 = สามวันแรกที่เข้าเงื่อนไข "ต้องจองล่วงหน้า" ด้านล่าง)' }),
        defineField({ name: 'minNotice', title: 'ต้องจองล่วงหน้าอย่างน้อย', type: 'number', description: 'กันจองกระทันหัน — ตัวเลขใช้คู่กับหน่วยด้านล่าง เช่น 3 ชั่วโมง = ซ่อนคิวที่จะถึงภายใน 3 ชม. · 7 วัน = เริ่มจองได้อีก 7 วันข้างหน้า · เว้นว่าง = รับถึงนาทีสุดท้าย' }),
